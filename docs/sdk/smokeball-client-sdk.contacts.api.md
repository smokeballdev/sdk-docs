...
|  Method | Description |
|  --- | --- |
|  [create(request)](./smokeball-client-sdk.contacts.api.create.md) | Create a new contact and returns the contact.<!-- -->Currently only Person contacts are supported. |
...
|  [update(request)](./smokeball-client-sdk.contacts.api.update.md) | Updates the contact associated to the specified contact id and returns the contact.<!-- -->Currently only Person contacts are supported. |
